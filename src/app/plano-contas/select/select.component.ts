...
export class PlanoContasSelectComponent  implements OnInit, AfterViewInit {
  ...
  displayedColumns: string[] = ['codigo', 'descricao', 'tpConta', 'actions'];
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<PlanoContasSelectComponent>) {}
