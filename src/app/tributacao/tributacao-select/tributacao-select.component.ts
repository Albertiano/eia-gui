...
@Component({
  selector: 'eia-tributacao-select',
  templateUrl: './tributacao-select.component.html',
  styleUrls: ['./tributacao-select.component.scss'],
  animations: [
...
export class TributacaoSelectComponent  implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<TributacaoSelectComponent>) {}
