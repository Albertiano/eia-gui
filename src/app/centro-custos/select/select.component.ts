...
export class CentroCustosSelectComponent  implements OnInit, AfterViewInit {
  ...
  constructor(
    ...
    private service: CentroCustosService,
    private dialogRef: MatDialogRef<CentroCustosSelectComponent>) {}
